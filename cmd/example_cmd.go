...
var (
	/////////////// singleAutocomplete
	singleAutocompleteCommand = &discordgo.ApplicationCommand{
	...
	singleAutocompleteHandler = func(s *discordgo.Session, i *discordgo.InteractionCreate) {
		switch i.Type {
	...
	//////////////// multiAutocomplete
	multiAutocompleteCommand = &discordgo.ApplicationCommand{
	...
	multiAutocompleteHandler = func(s *discordgo.Session, i *discordgo.InteractionCreate) {
		switch i.Type {
		case discordgo.InteractionApplicationCommand:
			data := i.ApplicationCommandData()
			err := s.InteractionRespond(i.Interaction, &discordgo.InteractionResponse{
...
var (
	commands = []*discordgo.ApplicationCommand{
		singleAutocompleteCommand,
		multiAutocompleteCommand,
	}

	commandHandlers = map[string]func(s *discordgo.Session, i *discordgo.InteractionCreate){
		"single-autocomplete": singleAutocompleteHandler,
		"multi-autocomplete":  multiAutocompleteHandler,
	}
)

func GetExampleCommands() []*discordgo.ApplicationCommand {
	return commands
}

func GetExampleHandlers() map[string]func(s *discordgo.Session, i *discordgo.InteractionCreate) {
